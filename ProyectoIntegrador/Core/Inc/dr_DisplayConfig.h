...
#ifndef INC_DR_DISPLAYCONFIG_H_
#define INC_DR_DISPLAYCONFIG_H_
...
#define ST7735_RES_Pin      		DISPLAY_RST_Pin
#endif
#ifndef ST7735_RES_GPIO_Port
#define ST7735_RES_GPIO_Port		DISPLAY_RST_GPIO_Port
#endif
//Port and pin connected signal 'DC' (data or command) ST7735 display
#ifndef ST7735_DC_Pin
#define ST7735_DC_Pin				DISPLAY_A0_Pin
#endif
#ifndef ST7735_DC_GPIO_Port
#define ST7735_DC_GPIO_Port			DISPLAY_A0_GPIO_Port
#endif
//Port and pin connected signal 'CS' (chip select) ST7735 display
#ifndef ST7735_CS_Pin
#define ST7735_CS_Pin				DISPLAY_CS_Pin
#endif
#ifndef ST7735_CS_GPIO_Port
#define ST7735_CS_GPIO_Port			DISPLAY_CS_GPIO_Port
#endif
